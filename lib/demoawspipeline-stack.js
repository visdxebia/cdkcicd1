...
class DemoawspipelineStack extends Stack {
  ...
  constructor(scope, id, props) {
    ...
    let latestStringToken = ssm.StringListParameter.fromStringListParameterName(this, 'clientToOnboardConfig', 'clientToOnboardConfig');
    new ssm.StringParameter(this, 'Parameter', {
      allowedPattern: '.*',
      description: 'The value Foo',
      parameterName: 'FooParameter',
      stringValue: `${_.get(latestStringToken, "id", "not found")}${latestStringToken}`,
